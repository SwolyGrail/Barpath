...
(function (global) {
  ...
  PROGRAMS.powerbuilding = {
    ...
    3: [
      day("Upper", "Chest, back, shoulders & arms", [
        ...
        M("Weighted Pull-Ups", "back", "pullup", "5–8", 3),
    ...
    4: [
      day("Upper Power", "Heavy pressing & pulling", [
        ...
        M("Weighted Pull-Ups", "back", "pullup", "4–6", 4),
    ...
    5: [
      ...
      day("Pull", "Back & biceps", [
        W(),
        M("Weighted Pull-Ups", "back", "pullup", "5–8", 4),
  ...
  PROGRAMS.hypertrophy = {
    ...
    3: [
      ...
      day("Pull", "Back & biceps", [
        W(),
        M("Weighted Pull-Ups", "back", "pullup", "8–10", 4),
  ...
  var PR_LIFTS = [
    ...
    { id: "pullup", name: "Weighted Pull-Ups" }
  ];
